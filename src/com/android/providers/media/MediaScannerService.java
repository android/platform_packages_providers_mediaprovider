                ...
                if (filePath != null) {
                    ...
                    if (MediaProvider.INTERNAL_VOLUME.equals(volume)) {
                        ...
                        if (getSystemService(UserManager.class).isDemoUser()) {
                            ...
                            if (volumePath != null && ArrayUtils.contains(mExternalStoragePaths, volumePath))
                                directories = new String[] { volumePath };
                            else {
                                Log.e(TAG, "Unknown path " + volumePath + ", legal paths are " + Arrays.toString(mExternalStoragePaths));
